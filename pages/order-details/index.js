              ...
              wx.request({
                ...
                success: (res) => {
                  if (res.data.code == 0) {
                    ...
                    app.sendTempleMsgImmediately('ZH2jCVMa88OMxki3C65hLL1WB0Cq4ZoOWAzMVd0kwUU', formId,
      ...
      wx.request({
        ...
        success: (res) => {
          ...
          if (res.data.code == 0) {
            ...
            postJsonString.keyword2 = { value: keywords2, color: '#173177' }
            app.sendTempleMsgImmediately('lKBY11dSkxiii6GB833V-hFfHjbBYs0vFt_otqMKG_4', formId,
